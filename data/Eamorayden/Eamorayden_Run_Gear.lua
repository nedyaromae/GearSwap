  ...
  sets.Enmity = {ammo={name="Sapience Orb",priority=3},
   ...
   --RUN stuff 
	...
	sets.precast.JA['One for All'] ={ammo={name="Sapience Orb",priority=3},
        head={name="Null Masque",priority=100},neck={name="Unmoving Collar +1",priority=200},ear1={name="Alabaster Earring",priority=99},ear2={name="Tuisto Earring",priority=150},
   ...
   sets.precast.FC ={ ammo={name="Sapience Orb",priority=3},
        head={name="Runeist Bandeau +4",priority=119},neck={name="Orunmila's Torque",priority=1},ear1={name="Enchntr. Earring +1",priority=4},ear2={name="Loquac. Earring",priority=8},
...
sets.Kiting={ring2={name="Shneddick Ring",priority=4},}
    ...
    sets.engaged.Meva={ammo={name="Staunch Tathlum +1",priority=3},
        head={name="Nyame Helm",priority=91},neck={name="Futhark Torque +1",priority=45},ear1={name="Eabani Earring",priority=45},ear2={name="Erilaz Earring +2",priority=6},
    ...
    sets.engaged.Evasion={ammo={name="Staunch Tathlum +1",priority=3},
        head={name="Null Masque",priority=100},neck={name="Futhark Torque +1",priority=45},ear1={name="Eabani Earring",priority=45},ear2={name="Tuisto Earring",priority=150},
