  ...
  sets.Enmity = {ammo={name="Sapience Orb",priority=3},
   ...
   sets.precast.FC ={ ammo={name="Sapience Orb",priority=3},
    ...
    sets.precast.WS = {ammo={name="Oshasha's treatise",priority=3},
        ...
        body={name="Nyame Mail",priority=136},hands={name="Nyame Gauntlets",priority=91},ring1={name="Cornelia's Ring",priority=6},ring2={name="Sroda Ring",priority=8},
        back=gear.enmity_jse_back,{priority=60},waist={name="Plat. Mog. Belt",priority=300},legs={name="Nyame Flanchard",priority=114},feet={name="Nyame Sollerets",priority=68}}
    ...
    sets.precast.WS.DD={ammo={name="Oshasha's treatise",priority=3},
        ...
        back=gear.enmity_jse_back,{priority=60},waist={name="Sailfi Belt +1",priority=8},legs={name="Nyame Flanchard",priority=114},feet={name="Sulev. Leggings +2",priority=20}}
	...
	sets.precast.WS['Chant du Cygne'] = sets.precast.WS['Requiescat']
	...
	sets.midcast.Flash.SIRD = sets.midcast.Flash

    sets.midcast.Flash.Meva=sets.Enmity.Meva

    sets.midcast['Divine Magic'] = sets.SIRD

	sets.midcast['Blue Magic'] = sets.Enmity.SIRD

	sets.midcast['Blue Magic']['Blank Gaze'] = sets.Enmity

	sets.midcast['Blue Magic']['Jettatura'] = sets.Enmity
   ...
   sets.HPCure={ammo={name="Staunch Tathlum",priority=1},
    ...
    sets.midcast.Reprisal = {ammo={name="Sapience Orb",priority=3},
        head={name="Chev. Armet +2",priority=135},neck={name="Loricate Torque +1",priority=1},ear1={name="Tuisto Earring",priority=150},ear2={name="Chev. Earring +1",priority=5},
        body={name="Shabti Cuirass",priority=102},hands={name="Sakpata's Gauntlets",priority=91},ring1=gear.left_moonbeam,{priority=100},ring2={name="Defending Ring",priority=2},
    ...
    sets.midcast['Enhancing Magic'] = {ammo={name="Pemphredo Tathlum",priority=3},
      ...
      sets.midcast['Enhancing Magic'].SIRD={ammo={name="Staunch Tathlum",priority=1},
        ...
        body={name="Chev. Cuirass +2",priority=141},hands={name="Sakpata's Gauntlets",priority=91},ring1=gear.left_moonbeam,{priority=100},ring2={name="Defending Ring",priority=6},
    ...
    sets.midcast['Enlight II'].SIRD=sets.midcast['Enlight'].SIRD
	...
	sets.midcast.HolyII = {ammo={name="Pemphredo Tathlum",priority=3},
        ...
        body={name="Nyame Mail",priority=136},hands={name="Nyame Gauntlets",priority=91},ring1={name="Metamorph Ring +1",priority=6},ring2={name="Moonbeam Ring",priority=100},
	...
	sets.midcast.Holy=sets.midcast.HolyII

    sets.midcast.CureNuke=sets.midcast.Holy

    sets.midcast.Raise=sets.midcast['Enhancing Magic'].SIRD
    ...
    head={name="Sakpata's Helm",priority=91},neck={name="Warder's Charm +1",priority=1},ear1={name="Tuisto Earring",priority=150},ear2={name="Chev. Earring +1",priority=4},
    body={name="Sakpata's Plate",priority=136},hands={name="Sakpata's Gauntlets",priority=91},ring1={name="Shadow Ring",priority=6},ring2={name="Shneddick Ring",priority=7},
    ...
    sets.engaged.Cleave=sets.idle.Cleave 
