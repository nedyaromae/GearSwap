...
function init_gear_sets()
    ...
    sets.precast.JA.Meditate = {back=gear.stp_jse_back,head="Wakido Kabuto +4",hands="Sakonji Kote +2"}
    ...
    sets.precast.FC = {head="Null Masque",neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Loquac. Earring",
    ...
    sets.precast.WS['Tachi: Ageha'] = {ammo="Pemphredo Tathlum",
		head="Wakido Kabuto +4",neck="Null Loop",ear1="Digni. Earring",ear2="Kasuga Earring +2",
		body="Kasuga Domaru +2",hands="Wakido Kote +4",ring1="Metamorph Ring +1",ring2="Murky Ring",
    ...
    sets.midcast.FastRecast = {
        head="Null Masque",neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Loquac. Earring",
        body="Nyame Mail",hands="Leyline Gloves",ring1="Naji's Loop",ring2="Prolix Ring",
        back="Solemnity Cape",waist="Null Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
